...
public class LeftBracketAnalyzer extends Analyzer {
	public LeftBracketAnalyzer(Input input, AnalyzerFactory analyzerFactory) {
	...
	public void analyze(TokenBase tokenBase) {
		...
		if (currentLexeme.getTokenType() != SquareBracket.LEFT_SQUARE_BRACKET) {
